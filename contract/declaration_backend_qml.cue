...
backends: qml: #DeclaredBackend & {
	...
	provisioning: {strategy: "path", owner: {runtime: "user", ci: "workflow-step"}, cacheInputs: [".github/workflows/pytest.yml#Install QML language server"], executables: ["qmlls6", "qmlls"]}
