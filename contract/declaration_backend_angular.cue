...
backends: angular: #DeclaredBackend & {
	...
	testing: {tested: true, marker: "angular", fixtureRepo: "angular", testDir: "angular", bootstrap: {required: true, steps: [{kind: "npm-install", detail: "npm install --no-audit --no-fund --loglevel=warn"}], produces: ["node_modules/@angular/core/package.json"], onFailure: {ci: "skip", local: "skip"}}}
