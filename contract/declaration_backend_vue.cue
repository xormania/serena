...
backends: vue: #DeclaredBackend & {
	...
	provisioning: {strategy: "composite", owner: {runtime: "serena", ci: "runtime"}, cacheInputs: ["src/solidlsp/language_servers/vue_language_server.py#vue_language_server_version"], primary: {strategy: "npm", packages: [{name: "@vue/language-server", pin: "3.1.5"}]}, companions: [{name: "typescript", provisioning: {strategy: "npm", packages: [{name: "typescript", pin: "5.9.3"}, {name: "typescript-language-server", pin: "5.1.3"}]}}]}
	testing: {tested: true, marker: "vue", fixtureRepo: "vue", testDir: "vue"}
