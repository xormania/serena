...
backends: hlsl: #DeclaredBackend & {
	...
	provisioning: {strategy: "download", owner: {runtime: "serena", ci: "runtime"}, cacheInputs: ["src/solidlsp/language_servers/hlsl_language_server.py#_DEFAULT_VERSION"], pin: "1.3.1", checksums: "default-version-only", hosts: ["github.com", "release-assets.githubusercontent.com", "objects.githubusercontent.com"]}
