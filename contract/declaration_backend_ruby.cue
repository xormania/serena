...
backends: ruby: #DeclaredBackend & {
	...
	provisioning: {strategy: "package-manager", owner: {runtime: "project", ci: "workflow-step"}, cacheInputs: ["Gemfile.lock", "src/solidlsp/language_servers/ruby_lsp.py#RUBY_LSP_VERSION"], manager: "bundler/gem", pin: "0.26.8"}
