...
backends: ansible: #DeclaredBackend & {
	...
	ci: _CIExpected & _BatchOther & _CINonWindows & {skipPolicy: {category: 3, toolProbe: "ansible-language-server"}} & {installStep: "Install ansible-core and ansible-lint (for Ansible language server tests)"}
}
