...
backends: ada: #DeclaredBackend & {
	...
	provisioning: {strategy: "download", owner: {runtime: "serena", ci: "workflow-step"}, cacheInputs: ["src/solidlsp/language_servers/ada_language_server.py#DEFAULT_ALS_VERSION"], pin: "2026.2.202604091", checksums: "default-version-only", hosts: ["github.com"]}
